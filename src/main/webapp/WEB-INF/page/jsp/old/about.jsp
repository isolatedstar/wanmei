    ...
    <section class="container">
        <div class="row">
            ...
            <section class="col-sm-8 maincontent">
                <h3>Our Company</h3>
                <p>
                    <img src="${pageContext.request.contextPath}/images/about.jpg" alt="" class="img-rounded pull-right" width="300">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${pageContext.request.contextPath}/images/photo-1.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>John Doe</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${pageContext.request.contextPath}/images/photo-2.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Larry Doe</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${pageContext.request.contextPath}/images/photo-3.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Ranith Kays</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${pageContext.request.contextPath}/images/photo-4.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Joan Ray</h4>
                        <!-- Designation -->
